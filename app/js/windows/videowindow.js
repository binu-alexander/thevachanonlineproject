...
var VideoWindow = function(id, parent, data) {

	var mediaLibraries = null,
		contentToProcess = null,
		currentSectionId = '';
		header = $('<div class="window-header"><span class="window-title i18n" data-i18n="[html]windows.video.label"></span></div>').appendTo(parent.node),
	...
	function processContent() {
		...
		// var checkDirectory = 'video_hindi';
		...
		for (var i=0; i<allVideos.length; i++) {
			...
			html += '<img id="' + mediaForVerse.name + '" title="' + mediaForVerse.name + '" class="triggerVideo" style="cursor:pointer" src="' + thumbUrl + '"/>&nbsp;';
			console.log(html);
...
//sofia.windowTypes.push('VideoWindow');
